          ...
          <div class="row">
            <div class="col-xl-7 col-lg-8">
              <div class="section-title mb-0 style-white">
                <h2 class="title">
                  Our students come from every country in the world!
                </h2>
                <a class="btn btn-black" href="course-single.html"
                  >Enroll Today</a
                >
              </div>
            </div>
            <div class="col-xl-5 col-lg-4 d-none d-lg-block">
              <img class="thumb" src="@/assets/img/other/5.png" />
            </div>
          </div>
        </div>
      </div>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 pl-lg-5 pr-5 pr-lg-0">
              <div class="widget widget_contact pr-lg-3">
                ...
                <ul class="details style-icon">
                  ...
                  <li>
                    <i class="fa fa-map-marker"></i> 9WX2+JM Thornton Heath,
                    United Kingdom
                  </li>
                </ul>
              </div>
