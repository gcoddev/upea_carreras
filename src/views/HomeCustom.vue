<template>
  <div>
          ...
          <div class="col-lg-6 align-self-center mt-4 mt-lg-0">
            <div class="section-title style-bg mb-0">
              ...
              <p class="content">
                ...
                day - for free! Check out the list below..
              </p>
              <div class="single-list-inner mt-4">
                <ul>
                  <li>
                    <i class="fa fa-check"></i> Access to 4,000+ of our top
                    courses
                  </li>
                  <li>
                    <i class="fa fa-check"></i> Explore a variety of fresh
                    topics
                  </li>
                  <li>
                    <i class="fa fa-check"></i> Find the right instructor for
                    you
                  </li>
                </ul>
              </div>
                ...
                <div class="details-inner">
                  <h5>
                    <a href="course-single.html"
                      >People Management Skills development</a
                    >
                  </h5>
                ...
                <div class="bottom-area">
                  <div class="row">
                    ...
                    <div class="col-6 align-self-center text-right">
                      <a class="readmore-text" href="course-single.html"
                        >Read More</a
                      >
                    </div>
                  </div>
            ...
            <div class="single-course-inner">
              ...
              <div class="details">
                ...
                <div class="details-inner">
                  <h5>
                    <a href="course-single.html"
                      >Skills development People Management</a
                    >
                  </h5>
                  <div class="author media">
                    <div class="media-left">
            ...
            <div class="single-course-inner">
              ...
              <div class="details">
                ...
                <div class="details-inner">
                  <h5>
                    <a href="course-single.html"
                      >Business Management Skills development</a
                    >
                  </h5>
                  <div class="author media">
                    <div class="media-left">
            ...
            <div class="single-course-inner">
              ...
              <div class="details">
                ...
                <div class="details-inner">
                  <h5>
                    <a href="course-single.html"
                      >Design Management Skills development</a
                    >
                  </h5>
                  <div class="author media">
                    <div class="media-left">
            ...
            <div class="single-course-inner">
              ...
              <div class="details">
                ...
                <div class="details-inner">
                  <h5>
                    <a href="course-single.html"
                      >Creative Design Skills development</a
                    >
                  </h5>
                  <div class="author media">
                    <div class="media-left">
            ...
            <div class="single-course-inner">
              ...
              <div class="details">
                ...
                <div class="details-inner">
                  <h5>
                    <a href="course-single.html"
                      >Digital Skills development Course</a
                    >
                  </h5>
                  <div class="author media">
                    <div class="media-left">
    ...
    <!-- counter start -->
    <div class="counter-area jarallax pd-top-120 pd-bottom-120 register-img">
      <div class="container">
        <div class="row">
            ...
            <div class="countdown-inner text-center">
              <div class="countdown">
                <div class="countdown-item">
                  <h2 class="countdown-number">40</h2>
                  <span class="countdown-text">Days</span>
                </div>
                <div class="countdown-item">
                  <h2 class="countdown-number">1</h2>
                  <span class="countdown-text">Hours</span>
                </div>
                <div class="countdown-item">
                  <h2 class="countdown-number">22</h2>
                  <span class="countdown-text">Mins</span>
                </div>
                <div class="countdown-item">
                  <h2 class="countdown-number">38</h2>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="single-team-inner">
              ...
              <div class="details pt-5">
                ...
                <h5>
                  <a href="single-team.html">Maria Helen</a>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="single-team-inner">
              ...
              <div class="details pt-5">
                ...
                <h5>
                  <a href="single-team.html">Andrew Helper</a>
                  <span> - Marketor</span>
                </h5>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="single-team-inner">
              ...
              <div class="details pt-5">
                ...
                <h5>
                  <a href="single-team.html">Dipa Helen</a>
              ...
              <div class="single-event-inner style-white">
                <div class="media">
                  <div class="media-left">
                    ...
                    <div class="thumb">
                      <img src="@/assets/img/event/1.png" alt="img" />
                    </div>
                  </div>
                  <div class="details media-body align-self-center">
                    <div class="date">
                      <i class="fa fa-calendar"></i> 09 Dec, 2021
                    </div>
                    <p class="location">
                      <i class="fa fa-map-marker"></i>New york grand city 1247
                    </p>
                    <h5>
                      <a href="single-event.html"
                        >Conference for reducing global warming</a
                      >
                    </h5>
                  </div>
                </div>
              ...
              <div class="single-event-inner style-white mb-0">
                <div class="media">
                  <div class="media-left">
                    <i class="fa fa-users"></i>
                    <div class="thumb">
                      <img src="@/assets/img/event/2.png" alt="img" />
                    </div>
                  </div>
                  <div class="details media-body align-self-center">
                    <div class="date">
                      <i class="fa fa-calendar"></i> 2 Dec, 2021
                    </div>
                    <p class="location">
                      <i class="fa fa-map-marker"></i>New york grand city 1247
                    </p>
                    <h5>
                      <a href="single-event.html"
                        >Global Conference for reducing warming</a
                      >
                    </h5>
                  </div>
                </div>
              ...
              <div class="details">
                <div class="blog-meta">
                  <ul>
                    ...
                    <li class="date">April 19, 2020</li>
                  </ul>
                </div>
                <h4>
                  <a href="single-blog.html"
                    >Engage your ommunity like never before</a
                  >
                </h4>
                <a class="readmore-text" href="single-blog.html">Read More</a>
              </div>
            </div>
          </div>
          <div class="col-lg-4 col-md-6">
            <div class="single-blog-inner">
              ...
              <div class="details">
                ...
                <h4>
                  <a href="single-blog.html"
                    >Community like never before Engage your
                  </a>
                </h4>
                <a class="readmore-text" href="single-blog.html">Read More</a>
              </div>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="single-blog-inner">
              ...
              <div class="details">
                ...
                <h4>
                  <a href="single-blog.html"
                    >Mortin your ommunity like Ever Article</a
                  >
                </h4>
                <a class="readmore-text" href="single-blog.html">Read More</a>
              </div>
